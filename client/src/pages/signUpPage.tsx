    ...
    <Container sx={ContainerStyle}>
        ...
        <Box width="100%"> 
            <Box sx={{display:'flex',flexDirection:'column',gap:3,mx:{xs:2,sm:15,md:10,lg:6}}}>
                ...
                <TextField id="email" type="text" size='small' variant="outlined" placeholder="enter your name" required/>
                <FormLabel>Email</FormLabel>
                <TextField id="email" type="email" size='small' variant="outlined" placeholder="enter your email" required/>
                <FormLabel>Password</FormLabel>
                <TextField id="password" type="password" size='small' variant="outlined" placeholder="create password" required/>
                <Button id="login-btn" variant="contained" sx={{width:1}} >Sign up</Button>
